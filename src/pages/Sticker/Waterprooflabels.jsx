                ...
                <div className="main_mailer_Banner">
                    <div className="mailer" style={{height: 'auto'}}>
                        <div>
                            ...
                            <img className="mailer_image  show" src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/Water-Proof-Labels.webp?alt=media&token=8c96e69c-da13-48cd-b7d3-3239fcdddbca" alt="Advertising Boxes" />
                        </div>
                    </div>
                    <div className="main_small_mailer" style={{cursor: 'pointer'}}>
                        <img src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/Water-Proof-Label.png?alt=media&token=6cf03997-66d0-4ed4-9867-eb428ea9e4f9" width="68" height="68" alt="Advertising Boxes" />
                        <img src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/Printed-Water-Proof-Label.png?alt=media&token=4141f457-2d18-4758-ab75-09719ad4e177" width="68" height="68" alt="Advertising Boxes" />
                        <img src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/Custom-Water-Proof-Label.png?alt=media&token=a3681195-3e30-4e73-aa18-196d3f311709" width="68" height="68" alt="Advertising Boxes" />
                    </div>
                    <div className="main_small_detail">
                        <div data-nosnippet="true" className="mail_box">
                            <h2>
                                Water Proof Labels</h2>
