                ...
                <div className="main_mailer_Banner">
                    <div className="mailer" style={{height: 'auto'}}>
                        <div>
                            ...
                            <img className="mailer_image  show" src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/Custom%20Printed%20Labels.webp?alt=media&token=3691fb36-d3d2-48c0-815c-6e8b6fc9224d" alt="Advertising Boxes" />
                        </div>
                    </div>
                    <div className="main_small_mailer" style={{cursor: 'pointer'}}>
                        <img src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/Custom%20Printed%20Label.png?alt=media&token=545ec05b-b726-4120-9e1c-21b3b8ef7403" width="68" height="68" alt="Advertising Boxes" />
                        <img src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/Printed%20Custom%20Label.png?alt=media&token=4d674d83-bd2d-4922-97ca-f3f76df38c31" width="68" height="68" alt="Advertising Boxes" />
                        <img src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/Custom%20Label.png?alt=media&token=5d60df69-697a-42f7-b5b1-8c2f437626d9" width="68" height="68" alt="Advertising Boxes" />
                    </div>
