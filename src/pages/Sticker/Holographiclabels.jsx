                ...
                <div className="main_mailer_Banner">
                    <div className="mailer" style={{height: 'auto'}}>
                        <div>
                            ...
                            <img className="mailer_image  show" src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/Holographic%20Labels.webp?alt=media&token=175b844f-d1c3-4a0e-b2aa-b4c228d80c4b" alt="Advertising Boxes" />
                        </div>
                    </div>
                    <div className="main_small_mailer" style={{cursor: 'pointer'}}>
                        <img src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/Holographic%20Label.png?alt=media&token=92bf5c90-ab7b-4f86-a0e9-97656858cfaf" width="68" height="68" alt="Advertising Boxes" />
                        <img src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/Printed%20Holographic%20Label.png?alt=media&token=f58b4e6f-aaae-422e-b1e0-19977ee4d221" width="68" height="68" alt="Advertising Boxes" />
                        <img src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/Custom%20Holographic%20Label.png?alt=media&token=bd4e21b0-cac5-4462-9ab9-148446f1df1f" width="68" height="68" alt="Advertising Boxes" />
                    </div>
                    <div className="main_small_detail">
                        <div data-nosnippet="true" className="mail_box">
                            <h2>
                                Holographic Labels</h2>
...
export default Holographiclabels;