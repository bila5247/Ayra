  ...
  return (
    <>
        ...
        <div className="Vacancy">
              ...
              <div>
                <div className="description">
                  ...
                  <p style={{ textAlign: "justify" }}>
                    <p>
                      Attention to detail is paramount, as you'll ensure
                      accurate and transparent financial reporting. We seek
                      candidates with a strong educational background in
                      accounting or finance, along with proficiency in financial
                      software and ethical conduct. Your analytical skills will
                      aid in informed decision-making, and your ability to work
                      collaboratively within our team will be highly valued.
                      Join us and play a vital role in our financial success.
                    </p>
                  </p>
                  <p />
                </div>
          ...
          <div>
            <img src={mixImg} style={{ width: "100%", margin: "auto" }} />
          </div>
        </div>
            ...
            <div className="heading2">
              ...
              <ul>
                <span style={{ fontSize: 22, maxWidth: 1100 }}>
                  <ul>
                    <li>
                      Analyze the financial data and to provide the insight to
                      the company’s financial health, trends and performance.
                    </li>
                    <li>
                      Maintain the up-to-date financial records, including
                      ledger, journals and financial statements.
                    </li>
                    <li>
                      Monitor and control the expenses to maintain cost
                      efficiency.
                    </li>
                    <li>
                      Generate financial reports, including profit and loss
                ...
                <span style={{ fontSize: 22, maxWidth: 1100 }}>
                  <ul>
                    <li>
                      ...
                      field is typically required. Professional certifications
                      such as CPA (Certified Public Accountant) or ACCA
                      (Association of Chartered Certified Accountants) may be
                      preferred.
                    </li>
                    <li>
                      <strong> </strong>Ability to adapt to changing financial
                      circumstances and regulations<strong>.</strong>
                    </li>
                    <li>
                      Willingness to collaborate with colleagues in finance and
                      other departments.
                    </li>
                    <li>
                      Ability to identify and resolve financial issues and
                      discrepancies.
                    </li>
                    <li>
                      Efficiency in the accounting software and spread sheet
                      tools for ex ample Microsoft excel.
                    </li>
                  </ul>
                </span>
              </ul>
