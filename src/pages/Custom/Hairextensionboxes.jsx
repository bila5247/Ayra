                ...
                <div className="main_mailer_Banner">
                    <div className="mailer" style={{height: 'auto'}}>
                        <div>
                            ...
                            <img className="mailer_image  show" src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/hair-extention-boxes.webp?alt=media&token=fedac2bb-417b-4187-84cb-69e411eadbba" alt="Advertising Boxes" />
                        </div>
                    </div>
                    <div className="main_small_mailer" style={{cursor: 'pointer'}}>
                        <img src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/hair-extention-boxes.png?alt=media&token=3a83814c-2890-482e-9f69-1347af8131a8" width="68" height="68" alt="Advertising Boxes" />
                        <img src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/hair-extention-packaging-boxes.png?alt=media&token=c41209f0-8486-4d64-99cf-fd9d258d1e1e" width="68" height="68" alt="Advertising Boxes" />
                        <img src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/hair-extention-box-packaging.png?alt=media&token=051cff48-bd38-4fd4-8694-7adddf27608d" width="68" height="68" alt="Advertising Boxes" />
                    </div>
                    <div className="main_small_detail">
                        <div data-nosnippet="true" className="mail_box">
                            <h2>
                        Hair Extension Boxes</h2>
                ...
                <div className="main_mailer_unboxx">
                    <div className="adjust_wid">
                        ...
                        <div className="main_foldandflap">
                            <img className="fold_flap" src={Hair} layout="fill" objectfit="cover" objectposition="center" />
                        </div>
