    ...
    <>
      ...
      <div className="main_mailer_Banner">
        <div className="mailer" style={{ height: "auto" }}>
          <div>
            ...
            <img
              ...
              src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/Hard%20Box%20Packaging.webp?alt=media&token=3d1644bf-0db0-4ebf-b718-b6254379e825"
        ...
        <div className="main_small_mailer" style={{ cursor: "pointer" }}>
          <img
            src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/Hard%20Box%20Packaging.png?alt=media&token=5182f60d-03db-4d1b-a4c7-67937ad82eef"
            width="68"
            height="68"
            alt="Advertising Boxes"
          />
          <img
            src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/Hard%20Box.png?alt=media&token=52593c8f-0805-46ed-93be-82ce92b84cb2"
            width="68"
            height="68"
            alt="Advertising Boxes"
          />
          <img
            src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/Hard%20Boxes.png?alt=media&token=794e7382-5365-42ea-baa7-b79813619b49"
            width="68"
            height="68"
            alt="Advertising Boxes"
          />
          ...
          <div className="mailer_head_para">
            <p class="mailer_para1">
              ...
              <p style={{ textAlign: "justify" }}>
                Hard boxes have become the ubiquitous and indispensable solution
                for various industries. These sturdy containers are known for
                their durability and versatility. They can protect valuable
                items during transit. As a packaging solution, hardboard boxes
                play a crucial role in preserving the integrity of goods and
                contributing to good, positive experiences.
              </p>
            </p>
            <div
              style={{
