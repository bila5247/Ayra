    ...
    return (
        <>
            ...
            <div className="main_headers">
                ...
                </div> <div className="main_headers">
                    <div className="main_data">
                        <div className="main_header">
                            <div className="header">
                                <nav className="navbar navbar-expand-lg navbar-light">
                ...
                <div className="main_mailer_Banner">
                    <div className="mailer" style={{height: 'auto'}}>
                        <div>
                            ...
                            <img className="mailer_image  show" src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/bath-bomb-boxes.webp?alt=media&token=eb834e9e-5075-4adc-bd4a-b7be71517eb5" alt="Advertising Boxes" />
                        </div>
                    </div>
                    <div class="main_small_mailer" style={{cursor: 'pointer'}}>
                        <img src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/bath-bomb-boxes.png?alt=media&amp;token=94882df0-a28b-49ba-963b-38c7b565e2fb" width="68" height="68" alt="Bath Bomb Boxes"/>
                        <img src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/bath-bomb-box-packaging.png?alt=media&amp;token=8efe5f67-8a2e-47b2-9b29-8511624f3f97" width="68" height="68" alt="Bath Bomb Boxes"/>
                        <img src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/bath-bomb-packaging-boxes.png?alt=media&amp;token=bfec0e0d-5b58-466a-b75a-347da432c6b6" width="68" height="68" alt="Bath Bomb Boxes"/>
                    </div>
                ...
                <div className="main_mailer_unboxx">
                    <div className="adjust_wid">
                        ...
                        <div className="main_foldandflap">
                            <img className="fold_flap" src={Bath} layout="fill" objectfit="cover" objectposition="center" />
                        </div>
