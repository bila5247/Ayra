                ...
                <div className="main_mailer_Banner">
                    <div className="mailer" style={{ height: 'auto' }}>
                        <div>
                            ...
                            <img className="mailer_image  show" src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/box-with-window.webp?alt=media&token=b71957f7-61c3-4ef4-b1ad-b6057b87dd23" alt="Advertising Boxes" />
                        </div>
                    </div>
                    <div className="main_small_mailer" style={{ cursor: 'pointer' }}>
                        <img src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/box-with-window.png?alt=media&amp;token=aaa7a158-0288-48cf-b81d-a4a9c36d8875" width="68" height="68" alt="Box With Window" />
                        <img src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/box-with-window-2.png?alt=media&amp;token=dfaef202-6206-47cb-9b0e-b995a2a70c60" width="68" height="68" alt="Box With Window" />
                        <img src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/box-with-window-1.png?alt=media&amp;token=e51b39bd-0760-46a7-a667-4831e11c20ad" width="68" height="68" alt="Box With Window" />
                    </div>
                    <div className="main_small_detail">
                        <div data-nosnippet="true" className="mail_box">
                            <h2>
                                Box With Window Boxes</h2>
                ...
                <div className="main_mailer_unboxx">
                    <div className="adjust_wid">
                        ...
                        <div className="main_foldandflap">
                            <img className="fold_flap" src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/product-detail_image%2FAugust_2023%2Fdieline%20copy.webpFri%20Aug%2018%202023%2018%3A03%3A17%20GMT%2B0500%20(Pakistan%20Standard%20Time)?alt=media&token=4932788a-cb1d-483f-9d87-ce05a27efd38" layout="fill" objectfit="cover" objectposition="center" />
                        </div>
