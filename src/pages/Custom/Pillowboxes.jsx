...
import Pillow from "./images/3.jpg";
    ...
    <>
      ...
      <div className="main_mailer_Banner">
        <div className="mailer" style={{ height: "auto" }}>
          <div>
            ...
            <img
              ...
              src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/pillow-boxes.webp?alt=media&token=2d0d8805-4b95-4528-9d8a-bfec2ce7e667"
        ...
        <div className="main_small_mailer" style={{ cursor: "pointer" }}>
          <img
            src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/pillow-boxes.png?alt=media&token=ddab15a5-1e98-4b8b-8786-3c16bc87a906"
            width="68"
            height="68"
            alt="Advertising Boxes"
          />
          <img
            src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/pillow-box-packaging.png?alt=media&token=59562648-f370-4002-b84d-0a04ea8315fb"
            width="68"
            height="68"
            alt="Advertising Boxes"
          />
          <img
            src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/pillow-packging-box.png?alt=media&token=20d2838c-92df-4eff-b400-acb1a8bfc33e"
            width="68"
            height="68"
            alt="Advertising Boxes"
          />
