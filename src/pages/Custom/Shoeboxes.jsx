    ...
    <>
      ...
      <div className="main_mailer_Banner">
        <div className="mailer" style={{ height: "auto" }}>
          <div>
            ...
            <img
              ...
              src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/shoe-boxes.webp?alt=media&token=2c10decb-4382-4591-8156-1154f59fcbcf"
        ...
        <div className="main_small_mailer" style={{ cursor: "pointer" }}>
          <img
            src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/shoe-boxes.png?alt=media&token=85b939c1-6660-4abf-9fa3-956b0a8e93be"
            width="68"
            height="68"
            alt="Advertising Boxes"
          />
          <img
            src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/custom-shoe-boxes.png?alt=media&token=b2b2753d-c254-4d3d-9b13-dff9fe94f21c"
            width="68"
            height="68"
            alt="Advertising Boxes"
          />
          <img
            src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/shoe-box-packaging.png?alt=media&token=33eb17ba-1d93-428a-8f12-6d96e5c4db2e"
            width="68"
            height="68"
            alt="Advertising Boxes"
          />
