                ...
                <div className="main_mailer_Banner">
                    <div className="mailer" style={{height: 'auto'}}>
                        <div>
                            ...
                            <img className="mailer_image  show" src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/Card-deck-boxes.webp?alt=media&token=b8f9a60a-a131-4d5b-8d4c-696882af71fb" alt="Advertising Boxes" />
                        </div>
                    </div>
                    <div className="main_small_mailer" style={{cursor: 'pointer'}}>
                    <img src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/Card-deck-boxes.png?alt=media&amp;token=9ff1ce5f-773b-403c-b959-2c35d6e99c4a" width="68" height="68" alt="Card Deck Boxes"/>
                    <img src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/Card-deck-box-packaging.png?alt=media&amp;token=55c5b4d8-359b-4a36-b44b-c136299a104a" width="68" height="68" alt="Card Deck Boxes"/>
                    <img src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/Card-deck-packaging-boxes.png?alt=media&amp;token=25c8f0b4-a0c9-4895-b007-4c5438090c90" width="68" height="68" alt="Card Deck Boxes"/>
                    </div>
                ...
                <div className="main_mailer_unboxx">
                    <div className="adjust_wid">
                        ...
                        <div className="main_foldandflap">
                            <img className="fold_flap" src={Card} layout="fill" objectfit="cover" objectposition="center" />
                        </div>
