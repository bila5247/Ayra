                ...
                <div className="main_mailer_Banner">
                    <div className="mailer" style={{height: 'auto'}}>
                        <div>
                            ...
                            <img className="mailer_image  show" src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/Candle-boxes.webp?alt=media&token=722037c3-ec03-4938-9556-b808daef1003" alt="Advertising Boxes" />
                        </div>
                    </div>
                    <div className="main_small_mailer" style={{cursor: 'pointer'}}>
                    <img src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/Candle-boxes.png?alt=media&amp;token=b274bcc3-b81b-447b-bb2f-c9194e2796c2" width="68" height="68" alt="Candle Boxes"/>
                    <img src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/Candle-packaging-boxes.png?alt=media&amp;token=d25d0854-141f-4810-bcfc-bc166ca7c247" width="68" height="68" alt="Candle Boxes"/>
                    <img src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/Candle-boxes.png?alt=media&amp;token=d44a401c-4449-41d0-a890-9c59da5092dc" width="68" height="68" alt="Candle Boxes"/>
                    </div>
                ...
                <div className="main_mailer_unboxx">
                    <div className="adjust_wid">
                        ...
                        <div className="main_foldandflap">
                            <img className="fold_flap" src={Candle} layout="fill" objectfit="cover" objectposition="center" />
                        </div>
