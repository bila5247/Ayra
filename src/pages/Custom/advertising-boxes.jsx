                ...
                <div className="main_mailer_Banner">
                    <div className="mailer" style={{ height: 'auto' }}>
                        <div>
                            ...
                            <img className="mailer_image  show" src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/Advertising-Boxes.webp?alt=media&amp;token=baa6d8ea-99a8-4bad-8db3-5f0aab0a1193" alt="Advertising Boxes" />
                        </div>
                    </div>
                    <div className="main_small_mailer" style={{ cursor: 'pointer' }}>
                        <img src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/Advertising-Boxes.png?alt=media&amp;token=6c47af92-c7b9-4865-a110-5b01ffc94927" width="68" height="68" alt="Advertising Boxes" />
                        <img src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/Printed-Advertising-Boxes.png?alt=media&amp;token=48e9efd0-6a22-403b-85bf-d5cb7e46f9df" width="68" height="68" alt="Advertising Boxes" />
                        <img src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/custom-Advertising-Boxes.png?alt=media&amp;token=6c0f5760-1410-4947-8748-e6c5b403eb8e" width="68" height="68" alt="Advertising Boxes" />
                    </div>
                    <div className="main_small_detail">
                        <div data-nosnippet="true" className="mail_box">
                            <h2>
                                Advertising Boxes</h2>
