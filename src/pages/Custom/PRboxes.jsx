      ...
      <div className="main_mailer_Banner">
        <div className="mailer" style={{ height: "auto" }}>
          <div>
            ...
            ></div>
            <img
              className="mailer_image  show"
              src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/pr-boxes.webp?alt=media&token=a2542349-e20e-49a5-b9e1-8ad43e68aed8"
              alt="Advertising Boxes"
            />
          </div>
        </div>
        <div className="main_small_mailer" style={{ cursor: "pointer" }}>
          <img
            src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/pr-boxes.png?alt=media&token=7a29cc21-ca3c-40f4-ab29-ad79435a082a"
            width="68"
            height="68"
            alt="Advertising Boxes"
          />
          <img
            src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/pr-box-packging.png?alt=media&token=f821d47a-01fd-4cb7-93ab-369d7806860e"
            width="68"
            height="68"
            alt="Advertising Boxes"
          />
          <img
            src="https://firebasestorage.googleapis.com/v0/b/biotech-c9081.appspot.com/o/pr-packging-boxes.png?alt=media&token=c4c36b1d-5702-4e92-8640-3274c8cc1e07"
            width="68"
            height="68"
            alt="Advertising Boxes"
          />
              ...
              <div>
                <div className="value_description">
                  <div className="size heading">
                    ...
                    <div>
                      <p>All Custom Sizes, Shapes, and Card Thickness</p>
                    </div>
                  </div>
                  <div className="size">
                    <div>
                    ...
                    <div>
                      <p>
                        PMS (Pantone Matching System), CMYK Printing Process
                      </p>
                    </div>
                  </div>
                  <div className="size">
                    ...
                    <div>
                      <p>
                        Bleach Board, Art Board, Grey Back Board, Card Board
                      </p>
                    </div>
                  </div>
                  <div className="size">
                    <div>
                      <p className="heading">Finishing: </p>
                    </div>
                    <div>
                      <p>
                        Soft Touch lamination, Gloss UV, Matte UV, Drip OFF,
                        Soft Lamination, Spot-UV, Hot Foiling, Embossing
                      </p>
                    </div>
                  </div>
                  <div className="size">
                    <div>
                      <p className="heading">Extra Finishing: </p>
                    </div>
                    <div>
                      <p>
                        Deep Embossing, 3D Printing, Micro Laser Embossing,
                        Glitter Finishing
                      </p>
                    </div>
                  </div>
                  <div className="size">
                    ...
                    <div>
                      <p>Custom Window Cut Out, Gold/Silver Foiling</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <p class="mailer_para1">
              <p class="MsoNormal">
                <b>
                  ...
                  >
                    Worthable Visibility and Impact by Using the Power of Ayra
                    Packages PR Boxes
                  </span>
                </b>
              ...
              <p>
                PR boxes have become a popular and powerful way for brands to
                generate excitement and engage with influencers. They create a
                memorable experience for their audience. Why the PR boxes become
                a cornerstone of marketing strategies?
              </p>
              <p>
                PR boxes are the curated packaging sent out to influencers,
                media outlets, and sometimes loyal customers. These boxes are
                designed for and filled with products with promotional materials
                and a personalized touch. This goal provides memorable, lasting
                experiences that not only showcase the brand products but also
                tell the story about your packaging and the material that is
                present inside.&nbsp;
              </p>
            </p>
            <div
              style={{
                display: "flex",
                justifyContent: "MozContextProperties",
                marginTop: "20px",
              }}
            ></div>
          </div>
